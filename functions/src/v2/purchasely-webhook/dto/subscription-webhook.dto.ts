...
export const PurchaselySubscriptionWebhookDtoSchema = {
  type: "object",
  properties: {
    name: {
      type: "string",
        ...
        product: {
          ...
          properties: {
            ...
            plan: {
              type: "object",
              properties: {
                type: { enum: [PurchaselyProductPlanType.RENEWING_SUBSCRIPTION, PurchaselyProductPlanType.NON_RENEWING_SUBSCRIPTION] },
                vendor_id: { type: "string" },
              },
